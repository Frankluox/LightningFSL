"""
The pretraining stage in paper "A New Meta-Baseline for Few-Shot Learning".
"""
...
import time 
import os
ex = Experiment("CE pretrain for PN", save_git_info=False)
...
def config():
    ...
    log_dir = "../results/"
    exp_name = "meta_baseline_pretrain/first_ex"
